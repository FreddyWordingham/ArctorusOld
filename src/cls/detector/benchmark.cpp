...
//  == HEADER ==
#include "cls/detector/benchmark.hpp"
...
namespace arc
{
    namespace detector
    {
        ...
        //  -- Constructors --
        /**
         *  Construct a detector with a given number of pixels and a given transformation from a base square mesh.
         *
         *  @param  t_name      Name of the camera.
         ...
         */
        Mat_detector::Mat_detector(const std::string& t_name, const size_t t_width, const size_t t_height, const bool t_col,
         ...
         *  @param  t_depth         The depth at which the photon was Raman scattered.
         */
        void Mat_detector::add_hit(const math::Vec<3>& t_pos, const double t_weight, const double t_wavelength, const int t_depth)
        {
            ...
            // Open file to save Raman scattering locations
            myfile.open ("loc.txt");
         ...
         */
        void Mat_detector::save(const std::string& t_output_dir, double t_norm) const
        {
            assert(t_norm > 0.0);
